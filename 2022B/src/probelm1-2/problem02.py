...
if __name__ == "__main__":
    ...
    for I in range(2, 10):     # I 从 2 到 9
        if I == T:
            continue
        angle_min1, angle_max1 = compute_angle_range_FY00_T_I(T, I)
        angle_min2, angle_max2 = compute_angle_range_FY0J_T_1(I, T)

        if angle_min1 <= alpha1 <= angle_max1 and angle_min2 <= alpha2 <= angle_max2:
            print(f"✅ 符合观测角度的编号: I = J = {I} 固定")

            R = 100

            r0, theta0 = locate_uav_correct(R, T, I, 1, alpha1, alpha2)
